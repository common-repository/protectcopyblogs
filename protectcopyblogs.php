<?php
/*
Plugin Name: ProtectCopyBlogs [Protect your Wordpress Blogfrom fraudulent copies]
...
update_option('PreventCopyBlogs_ser',$_POST['PreventCopyBlogs_ser']);
	...
	?>
	<div class="wrap">
	<h1>ProtectCopyBlogs</h1>
        <a href="http://www.techtipsmaster.com/wp-preventcopyblogs.html" target="_blank" title="Visit homepage of wordpress plugin ProtectCopyBlogs">Visit Plugin page</a> 
	<h2>ProtectCopyBlogs Options</h2>
...
<input type="checkbox" id="PreventCopyBlogs_nrc_t" name="PreventCopyBlogs_nrc_t" value="PreventCopyBlogs_nrc_t" <?php if($wp_PreventCopyBlogs_nrc_t == true) { echo('checked="checked"'); } ?> />
		...
		<p>Why don't you <a href="/wp-admin/post-new.php">write a post</a> about <a href="http://www.techtipsmaster.com/wp-preventcopyblogs.html" target="_blank">ProtectCopyBlogs</a> ?</p>
		<h3>Problems, Questions, Suggestions ?</h3>
		<p>If you find anything difficult or getting some errors,you can get support from <a href="http://www.techtipsmaster.com/wp-preventcopyblogs.html" target="_blank">ProtectCopyBlogs Homepage</a></p>
        </td>
        </tr>
        <tr>
...
function PreventCopyBlogs_adminmenu()
{
	if (function_exists('add_options_page')) {	
		add_options_page('ProtectCopyBlogs', 'ProtectCopyBlogs', 9, basename(__FILE__),'PreventCopyBlogs_options_page');
